...
declare module ITHit.WebDAV.Server.ResumableUpload {
	...
	*  <li><description>Pause/resume uploads.</description></li><br><li><description>Restore broken uploads.</description></li><br><li><description>Upload from AJAX using POST verb and create upload progress bars. Required in IE 9 and earlier only.</description></li><br><li><description>Upload to ASP.NET/IIS-based server files over 2Gb.</description></li><br></p><p> The WebDAV Server Engine can process two types of upload requests:
	*  <li><description>Pause/resume uploads.</description></li><br><li><description>Restore broken uploads.</description></li><br><li><description>Upload from AJAX using POST verb and create upload progress bars. Required in IE 9 and earlier only.</description></li><br><li><description>Upload to ASP.NET/IIS-based server files over 2Gb.</description></li><br></p><p> 
	...
	*  (see [IUploadProgress](ITHit.WebDAV.Server.ResumableUpload.IUploadProgress) interface description for more info).
	*  </p>
	*/
	export interface IResumableUpload extends IResumableUploadBase.ITHit.WebDAV.Server.ResumableUpload.IResumableUploadBase
	{
		/**
		* The date and time when the last chunk of file was saved in your storage.
		* #####
		* @remarks <br>Requested by the Engine during a call to [IUploadProgress.getUploadProgress](ITHit.WebDAV.Server.ResumableUpload.IUploadProgress#getuploadprogress) .
		*/
		lastChunkSaved: Date;
		/**
		...
		*  Usually AJAX/HTML based clients will use value returned by this property to display upload progress.</p><p> Requested by the Engine during a call to [IUploadProgress.getUploadProgress](ITHit.WebDAV.Server.ResumableUpload.IUploadProgress#getuploadprogress) .</p>
		*

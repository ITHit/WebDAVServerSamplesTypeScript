...
export declare class PropertyWriter {
    ...
    static WriteProperites(msWriter: MultistatusResponseWriter, item: IHierarchyItem, optionalProps: Array<PropertyName>, obligatoryProps: IEnumerable<PropertyName>, engine: DavEngine, context: DavContextBase, allprop: boolean): void;

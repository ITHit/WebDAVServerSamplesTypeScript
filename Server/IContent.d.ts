...
declare module ITHit.WebDAV.Server {
	...
	*/
	export interface IContent
	{
		...
		*  Change ETag every time a file content is updated in [write](ITHit.WebDAV.Server.IContent#write) method, together with a modification date. Do NOT change ETag when locking/unlocking a file. 
		*  </p><p> 

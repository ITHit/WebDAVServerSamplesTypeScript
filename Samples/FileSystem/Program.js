...
const DavEngine_1 = require("../../Server/DavEngine");
const DefaultLoggerImpl_1 = require("../../Server/Logger/DefaultLoggerImpl");
...
const DavResponse_1 = require("../../Server/Extensibility/DavResponse");
const protocol = 'http';
/**WebDAV engine host. */
class Program {
    /**
